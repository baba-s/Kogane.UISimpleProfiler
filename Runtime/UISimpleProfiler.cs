...
namespace Kogane.Internal
{
    ...
    internal sealed class UISimpleProfiler : MonoBehaviour
    {
        ...
        // 変数(SerializeField)
        //====================================================================================
        [SerializeField] private TMP_Text m_fpsTextUI;
        [SerializeField] private TMP_Text m_gcTextUI;
        [SerializeField] private TMP_Text m_monoUsedTextUI;
        [SerializeField] private TMP_Text m_monoTotalTextUI;
        [SerializeField] private TMP_Text m_unityUsedTextUI;
        [SerializeField] private TMP_Text m_unityTotalTextUI;

        //====================================================================================
        // 変数(readonly)
        //====================================================================================
        private readonly FPSCounter m_fPSCounter = new();
